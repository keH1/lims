<div class="measurement-wrapper">
	<b>Определение предела прочности при сжатии при 50° ГОСТ 12801-98</b><br>
				...
				<tr>
					...
					<td>
						<input type='number' step="any" min="0"
							   class="form-control list-input breaking_load_<?=$k?> change-trigger-asf50" name="form_data[<?=$this->data['ugtp_id']?>][form][P50][]"
							   value="<?=$this->data['measuring']['form']['P0'][$i] ?? ''?>">
					</td>
					<td>
						<input type='number' step="any"
							   class="form-control list-input square_<?=$k?> change-trigger-asf50" name="form_data[<?=$this->data['ugtp_id']?>][form][S50][]"
							   value="<?=$this->data['measuring']['form']['S0'][$i] ?? ''?>">
					</td>
					<td>
						<input type='number' step="any"
							   class="form-control list-input Strength_<?=$k?> change-trigger-asf50"
							   name="form_data[<?=$this->data['ugtp_id']?>][form][Str50][]"
							   value="<?=$this->data['measuring']['form']['Str0'][$i] ?? ''?>">
					</td>
					<?php if ($i === 0): ?>
					<td rowspan="3" class="align-middle">
						<input readonly type='number' step="any"
							   class="form-control list-input Average_Strength50" name="form_data[<?=$this->data['ugtp_id']?>][result_value]"
