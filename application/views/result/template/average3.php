<div class="measurement-wrapper" id="averageWrapper">
    <h3 class="mb-3">Методика с расчетом среднего значения по 3 наиб.</h3>

    <!--name="method_type" наименавание для всех типов метода одинаково-->
    <!--<input type="hidden" id="methodType" name="method_type" value="TU_sred3">-->
