<div class="measurement-wrapper" id="grainWrapper">
	...
	<div class="mb-3">
		<input class="form-check-input checkbox_grain" type="checkbox" value="1" name="checkbox" <?=$this->data['measuring']['checkbox'] ? 'checked' : ''?>>
		...
		<div class="result_value <?=$this->data['measuring']['checkbox'] ? '' : 'visually-hidden'?>">
			...
			<input class="form-check-input <?=$this->data['measuring']['checkbox'] ? '' : 'disabled'?>" type="number" step="any" value="<?=$this->data['measuring']['result_value']?>" name="result_value">
		</div>
	</div>
	<div class="zern <?=$this->data['measuring']['checkbox'] ? 'visually-hidden' : ''?>">
		...
		<input class="form-control initial_mass" type="number" name="initial_mass" step="0.01" value="<?=$this->data['measuring']['initial_mass']?>">
		...
		<?php if (!empty($this->data['measuring'])):?>
			<table class="table list_data graincomposition">
				...
				<tr>
					...
					<td class="text-center"><input class="form-check-input" type="checkbox" value="1" id="a" name="a_in_protocol" <?=$this->data['measuring']['a_in_protocol'] == 1 ? 'checked' : ''?>></td>
				...
				<tr>
					...
					<td class="text-center"><input class="form-check-input" type="checkbox" value="1" id="p" name="p_in_protocol" <?=$this->data['measuring']['p_in_protocol'] == 1 ? 'checked' : ''?>></td>
				...
				<tr>
					...
					<td class="text-center"><input class="form-check-input" type="checkbox" value="1" id="req" name="req_in_protocol" <?=$this->data['measuring']['req_in_protocol'] == 1 ? 'checked' : ''?>></td>
