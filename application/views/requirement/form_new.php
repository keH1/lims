            ...
            <div class="panel-body">
                <div class="wrapper-info-header">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-2 pt-2">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="tz[tests_for]" id="inlineRadio1" value="own" <?=$this->data['tz']['tests_for'] == 'own' ? 'checked' : ''?>>
                                <label class="form-check-label" for="inlineRadio1">для собственных нужд</label>
                            </div>
                        </div>
                        <div class="col-2 pt-2">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="tz[tests_for]" id="inlineRadio2" value="declaration" <?=$this->data['tz']['tests_for'] == 'declaration' ? 'checked' : ''?>>
                                <label class="form-check-label" for="inlineRadio2">для декларации</label>
                            </div>
                        </div>
                        <div class="col-4 pt-2">
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="inlineRadio3">для сертификации</label>
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2 pt-2">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="tz[presented_as]" id="inlineRadio31" value="protocol" <?=$this->data['tz']['presented_as'] == 'protocol' ? 'checked' : ''?>>
                                <label class="form-check-label" for="inlineRadio31">протокол испытаний</label>
                            </div>
                        </div>
                        <div class="col-sm-2 pt-2">
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="inlineRadio32">иное (указать)</label>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <input class="form-control" type="text" id="another_presented_as" value="<?=$this->data['tz']['another_presented_as']?? ''?>" name="tz[another_presented_as]" <?=$this->data['tz']['presented_as'] != 'another' ? 'disabled' : '' ?>>
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 pt-2">
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="inlineRadio41">паспорт</label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="inlineRadio42">ТУ</label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="inlineRadio43">состав</label>
                            </div>
                            <div class="form-check form-check-inline">
