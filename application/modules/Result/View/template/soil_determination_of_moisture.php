<div class="wrapper-soil-determination-of-moisture">
    <em class="info d-block mb-4">
        <strong>Определение влажности грунта методом высушивания до постоянной массы</strong>
    </em>
    ...
    <div>
        <button type="button" id="determinationOfMoisture" class="btn btn-primary">Рассчитать</button>
