<div class="measurement-wrapper">
	<b>Определение предела прочности при сжатии при 20° ГОСТ 12801-98</b><br>
				...
				<tr>
					...
					<td>
						<input type='number' step="any" min="0"
							   class="form-control list-input breaking_load_<?=$k?> change-trigger-asf20" name="form_data[<?=$this->data['ugtp_id']?>][form][P20][]"
							   value="<?=$this->data['measuring']['form']['P20'][$i] ?? ''?>">
					</td>
					<td>
						<input type='number' step="any"
							   class="form-control list-input square_<?=$k?> change-trigger-asf20" name="form_data[<?=$this->data['ugtp_id']?>][form][S20][]"
							   value="<?=$this->data['measuring']['form']['S20'][$i] ?? ''?>">
					</td>
					<td>
						<input type='number' step="any"
							   class="form-control list-input Strength_<?=$k?> change-trigger-asf20"
							   name="form_data[<?=$this->data['ugtp_id']?>][form][Str20][]"
							   value="<?=$this->data['measuring']['form']['Str20'][$i] ?? ''?>">
					</td>
					<?php if ($i === 0): ?>
					<td rowspan="3" class="align-middle">
						<input readonly type='number' step="any"
							   class="form-control list-input Average_Strength20" name="form_data[<?=$this->data['ugtp_id']?>][result_value]"
			...
			<tr>
				...
				<td>
					<input type='number' step="any" id="breaking_load_2"
						   class="form-control list-input change-trigger-asf20" name="P0[]"
						   value="<?= $averageStrength ? $averageStrength[$i]['P0'] : '' ?>">
				</td>
				<td>
					<input type='number' step="any" id="square_2"
						   class="form-control list-input change-trigger-asf20" name="S0[]"
						   value="<?= $averageStrength ? $averageStrength[$i]['S0'] : '' ?>">
				</td>
				<td>
					<input type='number' step="any" id="Strength_2"
						   class="form-control list-input change-trigger-asf20"
						   name="Str0[]"
			...
			<tr>
				...
				<td>
					<input type='number' step="any" id="breaking_load_4"
						   class="form-control list-input change-trigger-asf20" name="P20[]"
						   value="<?= $averageStrength ? $averageStrength[$i]['P20'] : '' ?>">
				</td>
				<td>
					<input type='number' step="any" id="square_4"
						   class="form-control list-input change-trigger-asf20" name="S20[]"
			...
			<tr>
				...
				<td>
					<input type='number' step="any" id="breaking_load_7"
						   class="form-control list-input change-trigger-asf20" name="P50[]"
						   value="<?= $averageStrength ? $averageStrength[$i]['P50'] : '' ?>">
				</td>
				<td>
					<input type='number' step="any" id="square_7"
						   class="form-control list-input change-trigger-asf20" name="S50[]"
