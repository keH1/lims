<div class="measurement-wrapper" id="averageWrapper">
    ...
    <div class="mb-3">
        ...
        <div class="td-actual-value">
            <input type="number" class="me-2 mb-2 actual-value w-100 border p-2 bg-white"
                   name="form_data[<?=$this->data['ugtp_id']?>][form][actual_value][0]" step="any"
                   value="<?= $this->data['measuring']['form']['actual_value'][0] ?>" required>
            <input type="number" class="me-2 mb-2 actual-value w-100 border p-2 bg-white"
                   name="form_data[<?=$this->data['ugtp_id']?>][form][actual_value][1]" step="any"
                   value="<?= $this->data['measuring']['form']['actual_value'][1] ?>" required>
            <input type="number" class="me-2 actual-value w-100 border p-2 bg-white"
                   name="form_data[<?=$this->data['ugtp_id']?>][form][actual_value][2]" step="any"
                   value="<?= $this->data['measuring']['form']['actual_value'][2] ?>" required>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            ...
            <input type="number" class="me-2 w-100 border p-2 bg-white" id="averageValue" name="form_data[<?=$this->data['ugtp_id']?>][form][result_value]"
                   step="any" value="<?= $this->data['measuring']['form']['result_value'] ?>">
        </div>
        <div class="col">
            <label for="decimalPlaces" class="form-label mb-1">Знаков после запятой</label>
            <input type="number" class="me-2 w-100 border p-2 bg-white" id="decimalPlaces" name="form_data[<?=$this->data['ugtp_id']?>][form][decimal_places]"
                   step="1" value="<?= $this->data['measuring_property']['form']['decimal'] ?>">
        </div>
    </div>
