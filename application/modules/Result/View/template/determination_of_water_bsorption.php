<div class="wrapper-water-bsorption">
    ...
    <table class="table average-density-table table-fixed mb-4">
        ...
        <tr class="table-secondary text-center align-middle">
            ...
            <th scope="col" class="border-0">Пористость щебня (гравия)</th>
        </tr>
        </thead>
        <tbody>
        <tr>
            ...
            <td class="text-center align-middle">
                <input type="number" class="form-control porosity-average-density"
                       step="any"
                       name="form_data[<?= $this->data['ugtp_id'] ?>][form][porosity_value]"
                       value="<?= $this->data['measuring']['form']['porosity_value'] ?? '' ?>" readonly>
            </td>
        </tr>
        </tbody>
    </table>
