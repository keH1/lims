                                        ...
                                        <tr class="<?= $val['table_green'] ?>">
                                            <td>
                                                <?php if (empty($val['upi_action'])): ?>
                                                    <a href="<?= URI ?>/result/resultCard/<?= $this->data['deal_id'] ?>?protocol_id=<?= $val['ID'] ?>"
                                            ...
                                            <td>
                                                <?php if ($val['is_create_protocol']): ?>
                                                    <?php if ($this->data['deal_id'] >= DEAL_START_NEW_AREA):?>
                                                        <a class="no-decoration me-1 <?= $this->data['deal_id'] >= DEAL_START_STOP_TESTS && !$this->data['is_deal_osk'] && empty($val['CHANGE_TRIALS_CONDITIONS']) ? 'validate-conditions' : 'validate-protocol' ?>"
                                                    ...
                                                    <?php endif ?>
                                                <?php else: ?>
                                                    <a class="no-decoration icon-disabled me-1" href="#"
                                                       title="Сформировать">
                                                        <svg class="icon" width="35" height="35">
                                                            <use xlink:href="<?= URI ?>/assets/images/icons.svg#form"/>
                                                        </svg>
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?>
                                                    <form class="form form-create-protocol" method="post"
                                                        ...
                                                        <button type="submit"
                                                                class="btn btn-primary add-protocol-number text-nowrap mt-0 <?= $this->data['deal_id'] >= DEAL_START_STOP_TESTS  && !$this->data['is_deal_osk'] && empty($val['CHANGE_TRIALS_CONDITIONS']) ? 'validate-conditions' : 'validate-protocol' ?>"
                                                                data-protocol_id="<?=$val['ID']?>"
                                        ...
                                        <tr class="<?= $val['table_green'] ?>">
                                            ...
                                            <td class="<?= $i === 0 ? 'probe-border-top' : '' ?> td-actual-value">
                                                ...
                                                <?php else: ?>
                                                    <div class="d-flex actual-value-wrapper mb-1">
                                                        <input <?= $val['actual_value_type'] ?>
                                                                class="me-2 actual-value actual-value-<?= $ugtp_id ?> w-100 border p-2 <?= $val['is_save_info'] ? 'bg-white' : 'bg-light-secondary' ?>"
                                                                name="actual_value[<?= $umtr_id ?>][<?= $ugtp_id ?>][]"
                                            ...
                                            <td class="<?= $i === 0 ? 'probe-border-top' : '' ?>">
                                                <?php if ($val['is_manual']): ?>
                                                    <select class="form-select match <?= $val['match_message'] ? 'is-invalid' : '' ?> <?= $val['is_save_info'] ? '' : 'disabled' ?>"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <input type="date" class="form-control date-begin <?=$this->data['is_deal_osk'] ? '' : 'date-trials'?>"
                                                        ...
                                                        <?= !empty($this->data['protocol']['CHANGE_TRIALS_DATE'] || $this->data['is_deal_osk']) ? '' : 'readonly' ?>>
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <label class="switch">
                                                            <input class="form-check-input output-in-protocol"
                                                                   name="OUTPUT_IN_PROTOCOL"
                                                                   type="checkbox"
                                                                <?= !empty($this->data['protocol']['OUTPUT_IN_PROTOCOL']) ? 'checked' : '' ?>>
                                                            <span class="slider"></span>
                                                        </label>
