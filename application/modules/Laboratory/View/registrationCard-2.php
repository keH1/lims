...
<div class="row">
    <div class="col-6">
                ...
                <?php foreach ($this->data["files"]["cert"] as $cert):  ?>
                    <div data-js-file-wrap class="position-relative" style="transition: 0.3s">
                        <a
                                ...
                                href="https://ulab.niistrom.pro/api/upload/lab/cert/<?= $this->data["cardInfo"]["id"] ?>/<?= $cert ?>"
                        ...
                        <button
                                data-js-delete-file="/api/upload/lab/cert/<?= $this->data["cardInfo"]["id"] ?>/<?= $cert ?>"
        ...
        <?php if (!empty($this->data["cardInfo"]["day_to_test"])): ?>
    ...
    <?php if ($this->data["cardInfo"]["deal_id"]): ?>
        <div class="col-6">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="ulab_comment" rows="5"><?= $this->data["cardInfo"]["comment_text"] ?? "" ?></textarea>
            </div>
        </div>
    <?php endif; ?>
</div>
...
<div class="scroll mt-3 mb-3">
    <div class="table-wrap">
        <table id="table" class="table table-striped journal" style="min-width: 100%">
            ...
            <?php foreach ($this->data["table"] as $gost) : ?>
                <tr>
