...
<form id="add-entry-modal-form-second" class="bg-light mfp-hide col-md-4 m-auto p-3 position-relative"
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <select name="reactive[id_reactive_model]" class="form-control h-auto select-reactive" required>
                <option value="" selected disabled></option>
                <?php
    ...
    <div>
        ...
        <div class="row mb-3">
            <div class="col">
                ...
                <input type="number" name="reactive[number]" step="1" min="1" max="10000"
    ...
    <div>
        <div class="row mb-3">
            <input type="number" name="reactive[id]"
                   value="" hidden="">
        </div>
    </div>
    <button type="submit" class="btn btn-primary">Отправить</button>
...
<form id="add-entry-modal-form-third" class="bg-light mfp-hide col-md-4 m-auto p-3 position-relative"
    ...
    <div class="row mb-3">
        <div class="col">
            <label class="form-label">Реактив</label>
            <select name="reactive_receive[id_reactive]"
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <div class="input-group">
                ...
                <input type="number" name="reactive_receive[number]" step="1" min="1" max="100"
                       class="form-control bg-white number-receive" required readonly>
                <input type="number" name="reactive_receive[id_library_reactive]"
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <input type="text" name="reactive_receive[doc_receive_name]" class="form-control">
        </div>
        <div class="col">
            <label class="form-label">Дата вход. документа</label>
            <input name="reactive_receive[doc_receive_date]" type="date"
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <input name="reactive_receive[date_receive]" type="date"
                   class="form-control filter filter-date-start"
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <input type="text" name="reactive_receive[number_batch]" class="form-control" required>
        </div>
        <div class="col">
            <label class="form-label">Количество</label>
            <div class="input-group">
                <input type="number" name="reactive_receive[quantity]" step="0.01" min="0" max="1000000"
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <input name="reactive_receive[date_production]" type="date"
                   class="form-control filter filter-date-start"
                   value="<?= $this->data['current_date'] ?>" required>
        </div>
        <div class="col">
            <label class="form-label">Срок годности</label>
            <input name="reactive_receive[date_expired]" type="date"
                   class="form-control filter filter-date-start"
                   value="<?= $this->data['current_date'] ?>" required>
        </div>
    </div>
    <div>
        <div class="row mb-3">
            <input type="number" name="reactive_receive[id]"
                   value="" hidden="">
        </div>
    </div>
    <button type="submit" class="btn btn-primary">Отправить</button>
