...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form action="/ulab/import/branchUpdate" method="post" class="form-horizontal">
            <input type="hidden" name="branch_id" id="branch_id" value="<?=$this->data['info']['id']?>">
...
<form id="popup_form" class="bg-light mfp-hide col-md-4 m-auto p-3 position-relative" action="/ulab/import/depInsertUpdate" method="post">
    ...
    <input type="hidden" name="form[branch_id]" value="<?=$this->data['info']['id']?>">
