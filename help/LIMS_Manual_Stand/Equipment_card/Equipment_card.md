...
- [Карточка оборудования](#карточка-оборудования)
  ...
  - [Структура карточки оборудования](#структура-карточки-оборудования)
    ...
    - [Блок «Технические и метрологические данные»](#блок-технические-данные)
...
5. Блок «Технические и метрологические данные»
...
<img src="png/i3.png" style="display: inline" text align=center> – нажмите на данную иконку чтобы вернуться в список оборудования.
...
* **Наименование испытаний, определяемая хар-ка или назначение** – введите сюда наименование характеристики / показателя, измеряемых при помощи данного оборудования.
...
### Блок «Технические и метрологические данные»

<p align=center>
<img src=png/5.png>
</p>

Введите в поля данного блока технические характеристики, диапазон измерения и класс точности оборудования. Информацию можно найти в документации к нему.
...
После того как вы заполните все поля, нажмите кнопку <img src="png/save.png" width=100 style="display: inline" text align=center>.
> **Результат:** введенная информация сохранена; карточка заявки создана и зарегистрирована в ЛИМС; в [Журнале оборудования](/Lists/Equipment_list/equipment_list.html) появилась соответствующая запись. 
