...
addFitter = (datasetMeta, ctx, dataset, xScale, yScale) => {
    ...
    let fitter = new LineFitter(dataset);
...
class LineFitter {
    ...
    f(x) {
        ...
        if (this.dataset.trendlineLinear.calculate) {
            ...
            let offset = this.dataset.trendlineLinear.offset;
            let scale = this.dataset.trendlineLinear.scale;
