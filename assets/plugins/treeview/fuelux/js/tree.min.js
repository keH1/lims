...
!function (t) {
	...
	e.prototype = {
		constructor: e, render: function () {
			this.populate(this.$element)
		}, populate: function (e) {
			var i = this, n = e.parent(), r = n.find(".tree-loader:eq(0)");
			...
			var i = t(e), n = this.$element.find(".tree-selected"), r = [];
			...
			r.length && this.$element.trigger("selected", {info: r}), i.trigger("updated", {
				info: r,
				item: i,
				eventType: o
			})
		}, selectFolder: function (e) {
			var i, n, r, o = t(e), s = o.parent(), a = s.find(".tree-folder-content"), l = a.eq(0);
			...
			var e = this.$element.find(".tree-selected"), i = [];
			...
			this.$element.find(".fa.fa-folder-open").each(function () {
				var i = t(this).removeClass("fa fa-folder fa-folder-open").addClass("fa fa-folder"),
					n = i.parent().parent(), r = n.children(".tree-folder-content");
				r.hide(), e || r.empty()
			})
		}
	}, t.fn.tree = function (i, n) {
		var r, o = this.each(function () {
			var o = t(this), s = o.data("tree"), a = "object" == typeof i && i;
