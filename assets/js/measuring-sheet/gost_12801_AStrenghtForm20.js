$('.AStrenghtForm .change-trigger-asf20').on('input', function (event) {
	...
	$parent.find('.Average_Strength0').val(round(average(arr0), 2));
	$parent.find('.Average_Strength20').val(round(average(arr20), 2));
	$parent.find('.Average_Strength50').val(round(average(arr50), 2));
});
